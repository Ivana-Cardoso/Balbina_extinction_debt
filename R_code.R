...
colnames(dados_5years)[1] <- "site_5year"
...
sp_marco    <- names(Aurelio_Silva_5)[7:ncol(Aurelio_Silva_5)]
sp_bueno    <- names(Bueno_comm_5)[7:ncol(Bueno_comm_5)]
sp_amarante <- names(Amarante_comm_5)[7:ncol(Amarante_comm_5)]
...
col_sp <- colnames(Aurelio_Silva_comm)[7:83]
